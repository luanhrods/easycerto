        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2 text-center lg:text-left">
              ...
              <Link href=`https://wa.me/${links.telOne}?text=Olá! Quero saber mais sobre as promoções de passagens aéreas.` className="text-[#179FCF] hover:text-[#1489b8] inline-flex items-center gap-2 font-semibold text-sm sm:text-base lg:text-[18px] hover-underline flex-link justify-center lg:justify-start">
