...
                <h2 className="text-2xl font-bold text-[#024E69] mb-6 text-center">Selecione a Companhia e a Quantidade</h2>
...
                    </select>
                  </div>
                  <button onClick={handleContinue} disabled={!selectedAirline || !selectedMiles} className="w-full bg-[#024E69] text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-[#1489b8] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed">Continuar</button>
                </div>
              </div>
            </div>
          )}
...
                    <p className="text-gray-600 mb-8">Sua solicitação de venda foi registrada com sucesso. Para agilizar o processo e finalizar a negociação, entre em contato conosco pelo WhatsApp.</p>
                    <Link
